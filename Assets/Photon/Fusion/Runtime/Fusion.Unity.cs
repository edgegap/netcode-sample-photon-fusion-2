...
namespace Fusion
{
    ...
    [Serializable]
    public partial class NetworkAssetSourceAddressable<T>
        where T : UnityEngine.Object
    {
        ...
        public T WaitForResult()
        {
            ...
            if (!_op.IsDone)
            {
                try
                {
                    ...
                    when (!Application.isPlaying && typeof(Exception) == e.GetType())
                {
                    LogError?.Log(
                        $"An exception was thrown when loading asset: {RuntimeKey}; since this method "
            ...
            if (_op.OperationException != null)
            {
                throw new InvalidOperationException(
                    $"Failed to load asset: {RuntimeKey}",
                    _op.OperationException
                );
            }
        ...
        private T ValidateResult(object result)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"Failed to load asset: {RuntimeKey}; asset is null"
                );
            }
            if (typeof(T).IsSubclassOf(typeof(Component)))
            {
                ...
                {
                    throw new InvalidOperationException(
                        $"Failed to load asset: {RuntimeKey}; asset is not a GameObject, but a {result.GetType()}"
                    );
                }
                ...
                {
                    throw new InvalidOperationException(
                        $"Failed to load asset: {RuntimeKey}; asset does not contain component {typeof(T)}"
                    );
                }
            ...
            throw new InvalidOperationException(
                $"Failed to load asset: {RuntimeKey}; asset is not of type {typeof(T)}, but {result.GetType()}"
            );
        }
...
namespace Fusion
{
    ...
    /// <typeparam name="T"></typeparam>
    [Serializable]
    public partial class NetworkAssetSourceResource<T>
        where T : UnityEngine.Object
    {
        /// <summary>
        ...
        public T EditorInstance =>
            string.IsNullOrEmpty(SubObjectName)
                ? UnityResources.Load<T>(ResourcePath)
                : LoadNamedResource(ResourcePath, SubObjectName);
#endif
    }
...
namespace Fusion
{
    ...
    /// <typeparam name="T"></typeparam>
    [Serializable]
    public partial class NetworkAssetSourceStatic<T>
        where T : UnityEngine.Object
    {
        /// <summary>
...
namespace Fusion
{
    ...
    /// <typeparam name="T"></typeparam>
    [Serializable]
    public partial class NetworkAssetSourceStaticLazy<T>
        where T : UnityEngine.Object
    {
        /// <summary>
...
namespace Fusion
{
    ...
    /// </summary>
    [Preserve]
    public class FusionGlobalScriptableObjectAddressAttribute
        : FusionGlobalScriptableObjectSourceAttribute
    {
        ...
        public override FusionGlobalScriptableObjectLoadResult Load(Type type)
        {
            ...
            LogTrace?.Log(
                $"Failed to load addressable at address {Address} for type {type.FullName}: {op.OperationException}"
            );
            return default;
#else
            LogTrace?.Log(
                $"Addressables are not enabled. Unable to load addressable for {type.FullName}"
            );
            return default;
#endif
        }
...
namespace Fusion
{
        ...
        : FusionGlobalScriptableObjectSourceAttribute
    {
        ...
        /// is to be used.</param>
        public FusionGlobalScriptableObjectResourceAttribute(
            Type objectType,
            string resourcePath = ""
        )
            : base(objectType)
        ...
        public override FusionGlobalScriptableObjectLoadResult Load(Type type)
        {
            ...
            if (string.IsNullOrEmpty(ResourcePath))
            {
                ...
                var indexOfResources = defaultAssetPath.LastIndexOf(
                    "/Resources/",
                ...
                {
                    LogTrace?.Log(
                        $"The default path {defaultAssetPath} does not contain a /Resources/ folder. Unable to load resource for {type.FullName}."
                    );
                    return default;
                }
            ...
            {
                LogTrace?.Log(
                    $"Unable to load resource at path {resourcePath} for type {type.FullName}"
                );
                return default;
            }
            ...
            else
            {
                return new(
                    ...
                    x => UnityEngine.Resources.UnloadAsset(instance)
                );
            }
        }
    }
...
namespace Fusion
{
    ...
    public class FusionUnityLogger : FusionUnityLoggerBase
    {
            ...
            try
            {
                ...
                if (LogActiveRunnerTick)
                {
                    ...
                    )
                    {
                        ...
                        sb.Append(
                            $"[Tick {(int)runner.Tick}{(runner.IsFirstTick ? "F" : "")}{(runner.Stage == 0 ? "" : $" {runner.Stage}")}] "
                        );
                    }
                }
        ...
        bool TryAppendSimulationBehaviourPrefix(
...
namespace Fusion
{
    ...
    public static class FusionProfiler
    {
        ...
        static void Init()
        {
            ...
            Fusion.EngineProfiler.InterpolationTimeScaleCallback = f =>
                InterpolationTimeScale.Sample(f);
            Fusion.EngineProfiler.InterpolationMultiplierCallback = f =>
                InterpolationMultiplier.Sample(f);
            Fusion.EngineProfiler.InterpolationUncertaintyCallback = f =>
                InterpolationUncertainty.Sample(f);
            ...
            Fusion.EngineProfiler.InputOffsetDeviationCallback = f =>
                InputOffsetDeviation.Sample(f);

            Fusion.EngineProfiler.InputRecvDeltaCallback = f => InputRecvDelta.Sample(f);
            Fusion.EngineProfiler.InputRecvDeltaDeviationCallback = f =>
                InputRecvDeltaDeviation.Sample(f);
        }
        ...
        public static readonly ProfilerCounter<float> InterpolationUncertainty =
            new ProfilerCounter<float>(
                Category,
                "Interp Uncertainty",
                ProfilerMarkerDataUnit.Undefined
            );

        public static readonly ProfilerCounter<int> InputSize = new ProfilerCounter<int>(
            Category,
            "Client Input Size",
            ProfilerMarkerDataUnit.Bytes
        );
        public static readonly ProfilerCounter<int> InputQueue = new ProfilerCounter<int>(
            Category,
            "Client Input Queue",
            ProfilerMarkerDataUnit.Count
        );

        public static readonly ProfilerCounter<int> WorldSnapshotSize = new ProfilerCounter<int>(
            Category,
            "Client Snapshot Size",
            ProfilerMarkerDataUnit.Bytes
        );
        public static readonly ProfilerCounter<int> Resimulations = new ProfilerCounter<int>(
            Category,
            "Client Resims",
            ProfilerMarkerDataUnit.Count
        );
        public static readonly ProfilerCounter<float> RoundTripTime = new ProfilerCounter<float>(
            Category,
            "Client RTT",
            ProfilerMarkerDataUnit.Count
        );

        public static readonly ProfilerCounterValue<int> RpcIn = new ProfilerCounterValue<int>(
            Category,
            "RPCs In",
            ProfilerMarkerDataUnit.Count,
            ProfilerCounterOptions.FlushOnEndOfFrame | ProfilerCounterOptions.ResetToZeroOnFlush
        );
        public static readonly ProfilerCounterValue<int> RpcOut = new ProfilerCounterValue<int>(
            Category,
            "RPCs Out",
            ProfilerMarkerDataUnit.Count,
            ProfilerCounterOptions.FlushOnEndOfFrame | ProfilerCounterOptions.ResetToZeroOnFlush
        ...
        public static readonly ProfilerCounter<float> InputOffset = new ProfilerCounter<float>(
            Category,
            "Input Offset",
            ProfilerMarkerDataUnit.Count
        );
        ...
        public static readonly ProfilerCounter<float> InputRecvDelta = new ProfilerCounter<float>(
            Category,
            "Input Recv Delta",
            ProfilerMarkerDataUnit.Count
        );
...
namespace Fusion
{
    ...
    public static class JsonUtilityExtensions
    {
        ...
        public static string ToJsonWithTypeAnnotation(
            object obj,
        ...
        /// <param name="instanceIDHandler">Handler for UnityEngine.Object references. If the handler returns an empty string,
        /// the reference is removed from the final result.</param>
        public static void ToJsonWithTypeAnnotation(
            object obj,
            TextWriter writer,
        ...
        public static T FromJsonWithTypeAnnotation<T>(
            string json,
        ...
        /// <param name="json">JSON to be parsed</param>
        /// <param name="typeResolver">Converts type name to a type instance.</param>
        public static object FromJsonWithTypeAnnotation(
            string json,
            TypeResolverDelegate typeResolver = null
        )
        {
        ...
        private static object FromJsonWithTypeAnnotationInternal(
            string json,
            TypeResolverDelegate typeResolver = null,
        ...
        )
        {
            ...
            writer.Write(
                typeResolver?.Invoke(type) ?? SerializableType.GetShortAssemblyQualifiedName(type)
            );
        ...
        private static object FromJsonWithTypeAnnotationToObject(
            ref int i,
            string json,
        ...
        )
        {
            if (json[i] == '{')
            {
                ...
                {
                    throw new InvalidOperationException(
                        $"Unable to find end of object's end (starting at {i})"
                    );
                }
                ...
                var typeInfo = JsonUtility.FromJson<TypeNameWrapper>(
                    part.Replace(
                        TypePropertyName,
                        nameof(TypeNameWrapper.__TypeName),
...
namespace Fusion
{
    ...
    public static class FusionAddressablesUtils
    {
        ...
        )
        {
            ...
            subObjectName = address.Substring(
                indexOfSquareBracket + 1,
                address.Length - indexOfSquareBracket - 2
            );
            return true;
        }
        ...
        public static AssetReference CreateAssetReference(string address)
        {
            if (TryParseAddress(address, out var mainPart, out var subObjectName))
            {
                if (System.Guid.TryParse(mainPart, out _))
                {
                    ...
                    return new AssetReference(mainPart) { SubObjectName = subObjectName };
                }
                else
                {
                    throw new System.ArgumentException(
                        $"The main part of the address is not a guid: {mainPart}",
                        nameof(address)
                    );
                }
            }
        ...
        {
            Assert.Check(
                s_loadEditorInstance != null,
                $"Call {nameof(SetLoadEditorInstanceHandler)} before using this method"
            );
...
namespace Fusion
{
    ...
    public static partial class FusionLogInitializer
    {
        ...
        static LogLevel GetEditorLogLevel()
        {
            ...
            var currentNamedBuildTarget = NamedBuildTarget.FromBuildTargetGroup(
                currentBuildTargetGroup
            );
            var defines = PlayerSettings
                .GetScriptingDefineSymbols(currentNamedBuildTarget)
                .Split(";");
            ...
            {
                FusionEditorLog.Warn(
                    $"{LogLevelTrace} is not supported in Fusion. Replacing with {LogLevelDebug}."
                );
            ...
            if (foundLogLevel == null)
            {
                ...
                {
                    FusionEditorLog.Log(
                        $"No log level define set for Fusion. Setting default: {defaultLogLevelDefine}"
                    );
                }

                ArrayUtility.Add(ref defines, defaultLogLevelDefine);
                PlayerSettings.SetScriptingDefineSymbols(
                    currentNamedBuildTarget,
                    string.Join(";", defines)
                );
...
namespace Fusion
{
    ...
    public partial class FusionMppm
    {
        ...
        public void Send<T>(T data)
            where T : FusionMppmCommand
        {
#if FUSION_ENABLE_MPPM && UNITY_EDITOR
            Assert.Check(
                Status == FusionMppmStatus.MainInstance,
                "Only the main instance can send commands"
            );
        ...
        public static void Broadcast<T>(T data)
            where T : FusionMppmCommand
        {
...
#if FUSION_ENABLE_MPPM && UNITY_EDITOR
        private static readonly string s_mainInstancePath = Path.GetFullPath(
        ...
        private readonly Regex _invalidFileCharactersRegex = new Regex(
            string.Format(
                @"([{0}]*\.+$)|([{0}]+)",
        ...
        static FusionMppm()
        {
            var indexOfMppmPrefix = Application.dataPath.LastIndexOf(
                "/Library/VP/mppm",
                StringComparison.OrdinalIgnoreCase
            );
            Status =
                indexOfMppmPrefix < 0
                    ? FusionMppmStatus.MainInstance
                    : FusionMppmStatus.VirtualInstance;
            ...
            if (Status == FusionMppmStatus.MainInstance)
            {
                ...
                // set up MPE channel
                var disconnect = ChannelService.GetOrCreateChannel(
                    MpeChannelName,
                    MainEditor.ReceiveAck
                );
                ...
                if (
                    Directory.Exists(PersistentCommandsFolderPath)
                    && !SessionState.GetBool(folderOwnedKey, false)
                )
                {
                    FusionEditorLog.TraceMppm(
                        $"Deleting leftover files from {PersistentCommandsFolderPath}"
                    );
                ...
                {
                    FusionEditorLog.TraceMppm(
                        $"Creating command folder {PersistentCommandsFolderPath}"
                    );
            ...
            else
            {
                ...
                var disconnect = client.RegisterMessageHandler(data =>
                {
                    ...
                    {
                        var ack = new AckMessage() { Guid = message.Guid };
                ...
                var mainInstanceCommandsFolderPath = Path.Combine(
                    s_mainInstancePath,
                    PersistentCommandsFolderPath
                );
        ...
        private void BroadcastInternal<T>(T data)
            where T : FusionMppmCommand
        {
            Assert.Check(
                Status == FusionMppmStatus.MainInstance,
            ...
            var wrapper = new CommandWrapper() { Guid = guid, Data = data };
            ...
            while (timer.Elapsed < timeout)
            {
                for (int i = 0; numAcks > 0 && i < _acks.Count; i++)
                {
                    ...
                    if (ack.guid == guid)
                    {
                        ...
                        FusionEditorLog.TraceMppm(
                            $"Received ack for {guid} from {ack.connectionId}, {numAcks} left"
                        );
                    }
                }
...
namespace Fusion
{
    ...
    public class FusionMppmRegisterCustomDependencyCommand : FusionMppmCommand
    {
        ...
        {
            FusionEditorLog.TraceMppm(
                $"Registering custom dependency {DependencyName} with hash {Hash}"
            );
...
namespace Fusion
{
    ...
    public static class FusionUnityExtensions
    {
        ...
        public static Object FindFirstObjectByType(
            System.Type type,
        ...
        public static Object FindAnyObjectByType(
            System.Type type,
            FindObjectsInactive findObjectsInactive
        )
        {
        ...
        public static T[] FindObjectsByType<T>(FindObjectsSortMode sortMode)
            where T : Object
        {
            return ConvertObjects<T>(
                FindObjectsByType(typeof(T), FindObjectsInactive.Exclude, sortMode)
            );
        }
...
namespace Fusion
{
    ...
    public class NetworkObjectBaker
    {
        ...
        private List<SimulationBehaviour> _allSimulationBehaviours =
            new List<SimulationBehaviour>();
            ...
            try
            {
                ...
                for (int i = 0; i < _allNetworkObjects.Count; ++i)
                {
                    ...
                    if (!objActive)
                    {
                        ...
                        {
                            Warn(
                                $"Unable to get execution order for {obj}. "
                    ...
                    for (
                        int scriptIndex = _allSimulationBehaviours.Count - 1;
                        scriptIndex >= 0;
                        --scriptIndex
                    )
                    {
                        ...
                        if (_pathCache.IsEqualOrAncestorOf(path, scriptPath))
                        {
                            ...
                            if (objExecutionOrder != null)
                            {
                                ...
                                if (TryGetExecutionOrder(script, out var scriptOrder))
                                {
                                    ...
                                    {
                                        Warn(
                                            $"{obj} execution order is less or equal than of the script {script}. "
                                ...
                                {
                                    Warn(
                                        $"Unable to get execution order for {script}. "
                                            + $"Because the object is initially inactive, Fusion is unable to guarantee "
                                            + $"the script's Awake will be invoked before Spawned. Please implement {nameof(TryGetExecutionOrder)}."
                                    );
                                }
                    ...
                    // what's left is nested network objects resolution
                    {
                        ...
                        for (
                            ;
                            j >= 0 && _pathCache.IsAncestorOf(path, _networkObjectsPaths[j]);
                            --j
                        )
                        {
        ...
        private bool Set<T>(MonoBehaviour host, ref T[] field, List<T> value)
        {
            ...
            if (
                field == null
                || field.Length != value.Count
                || !field.SequenceEqual(value, comparer)
            )
            {
                Trace($"Object dirty: {host} ({field} vs {value})");
                field = value.ToArray();
        ...
        public sealed unsafe class TransformPathCache
            : IComparer<TransformPath>,
                IEqualityComparer<TransformPath>
        {
            private Dictionary<Transform, TransformPath> _cache =
                new Dictionary<Transform, TransformPath>();
            ...
            public TransformPath Create(Transform transform)
            {
                ...
                if (depth > TransformPath.MaxDepth)
                {
                    ...
                    for (; i > 0; i -= TransformPath.MaxDepth)
                    {
                        checked
                        {
                            TransformPath path = new TransformPath(
                                (ushort)(depth - i),
                                nextPlusOne,
                                _siblingIndexStack,
                                i,
                                Mathf.Min(TransformPath.MaxDepth, depth - i)
                            );
                            _nexts.Add(path);
                ...
                var result = new TransformPath(
                    depth,
                    nextPlusOne,
                    _siblingIndexStack,
                    0,
                    Mathf.Min(TransformPath.MaxDepth, depth)
                );
            ...
            private int CompareToDepthUnchecked(in TransformPath x, in TransformPath y, int depth)
            {
                ...
                if (depth > TransformPath.MaxDepth)
                {
                    ...
                    return CompareToDepthUnchecked(
                        _nexts[x.Next - 1],
                        _nexts[y.Next - 1],
...
namespace Fusion
{
    ...
    [Serializable]
    public class NetworkPrefabSourceStatic
        : NetworkAssetSourceStatic<NetworkObject>,
    ...
    [Serializable]
    public class NetworkPrefabSourceStaticLazy
        : NetworkAssetSourceStaticLazy<NetworkObject>,
            INetworkPrefabSource
    {
        public NetworkObjectGuid AssetGuid;
        NetworkObjectGuid INetworkPrefabSource.AssetGuid => AssetGuid;
    ...
    [Serializable]
    public class NetworkPrefabSourceResource
        : NetworkAssetSourceResource<NetworkObject>,
            INetworkPrefabSource
    {
        public NetworkObjectGuid AssetGuid;
        NetworkObjectGuid INetworkPrefabSource.AssetGuid => AssetGuid;
    ...
    [Serializable]
    public class NetworkPrefabSourceAddressable
        : NetworkAssetSourceAddressable<NetworkObject>,
            INetworkPrefabSource
    {
        public NetworkObjectGuid AssetGuid;
        NetworkObjectGuid INetworkPrefabSource.AssetGuid => AssetGuid;
...
namespace Fusion.Statistics
{
    ...
    internal static class FusionStatisticsHelper
    {
        ...
        internal static void GetStatGraphDefaultSettings(
            RenderSimStats stat,
            out string valueTextFormat,
            out float valueTextMultiplier,
            out bool ignoreZeroOnAverage,
            out bool ignoreZeroOnBuffer,
            out int accumulateTimeMs
        )
        {
            valueTextFormat = "{0:0}";
        ...
        internal static float GetStatDataFromSnapshot(
            RenderSimStats stat,
            FusionStatisticsSnapshot simulationStatsSnapshot
        )
        {
            switch (stat)
            {
                ...
                case RenderSimStats.AverageInPacketSize:
                    return simulationStatsSnapshot.InBandwidth
                        / Mathf.Max(simulationStatsSnapshot.InPackets, 1);
                case RenderSimStats.AverageOutPacketSize:
                    return simulationStatsSnapshot.OutBandwidth
                        / Mathf.Max(simulationStatsSnapshot.OutPackets, 1);
                case RenderSimStats.InObjectUpdates:
...
namespace Fusion.Statistics
{
    ...
    public abstract partial class FusionStatsGraphBase : MonoBehaviour
    {
        ...
        private static readonly IFormatProvider _formatProvider = CultureInfo.GetCultureInfo(
            "en-US"
        );
        ...
        [SerializeField]
        protected float _valuesTextUpdateDelay = .1f;
        ...
        protected virtual void Initialize(int accumulateTimeMs)
        {
            ...
            _bufferValues = new FusionStatBuffer(
                _maxSamples,
                _ignoreZeroedValuesOnAverageCalculation,
                accumulateTimeMs
            );
        ...
        {
            if (_ignoreZeroedValuesOnBuffer && value == 0)
                return;
            ...
            for (
                int i = 0, k = _bufferValues.Index;
                i < _maxSamples;
                i++, k = (k + 1) % _bufferValues.Length
            )
            {
        ...
        protected virtual void OnSetValues()
        {
            if (Time.time >= _lastUpdateTime + _valuesTextUpdateDelay)
            {
                ...
                _averageValueText.text = GetValueText(
                    _bufferValues.AverageValue * _valueTextMultiplier
                );
...
namespace Fusion
{
    ...
    public static class FusionUnitySceneManagerUtils
    {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static T[] GetComponents<T>(this Scene scene, bool includeInactive)
            where T : Component
        {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static void GetComponents<T>(this Scene scene, List<T> results, bool includeInactive)
            where T : Component
        {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static T FindComponent<T>(this Scene scene, bool includeInactive = false)
            where T : Component
        {
            var rootObjects = _reusableGameObjectList;
            scene.GetRootGameObjects(rootObjects);
        ...
        public static int GetSceneBuildIndex(string nameOrPath)
        {
            ...
            else
            {
                for (int i = 0; i < SceneManager.sceneCountInBuildSettings; ++i)
                {
                    ...
                    GetFileNameWithoutExtensionPosition(
                        scenePath,
                        out var nameIndex,
                        out var nameLength
                    );
                    if (
                        nameLength == nameOrPath.Length
                        && string.Compare(scenePath, nameIndex, nameOrPath, 0, nameLength, true)
                            == 0
                    )
                    {
                        return i;
        ...
        public static void GetFileNameWithoutExtensionPosition(
            string nameOrPath,
            out int index,
            out int length
        )
...
namespace Fusion
{
    ...
    public static class NetworkRunnerVisibilityExtensions
    {
        ...
        private static readonly string[] RecognizedBehaviourNames = { "EventSystem" };
        ...
        private static LinkedList<RunnerVisibilityLink> GetVisibilityNodes(
        ...
        public static void AddVisibilityNodes(this NetworkRunner runner, GameObject go)
        {
            ...
            var existingEnableOnSingles =
                go.transform.GetComponentsInChildren<EnableOnSingleRunner>(true);
            List<RunnerVisibilityLink> existingNodes =
                go.GetComponentsInChildren<RunnerVisibilityLink>(false).ToList();
        ...
        private static void CollectBehavioursAndAddNodes(
            GameObject go,
            NetworkRunner runner,
            List<RunnerVisibilityLink> existingNodes
        )
        ...
        private static void RefreshRunnerVisibility(
            NetworkRunner runner,
            bool refreshCommonObjects = true
        )
        {
        ...
        private static readonly Dictionary<string, List<RunnerVisibilityLink>> CommonObjectLookup =
            new Dictionary<string, List<RunnerVisibilityLink>>();
        ...
        internal static void RefreshCommonObjectVisibilities()
        {
            ...
            foreach (var kvp in CommonObjectLookup)
            {
                ...
                if (clones.Count > 0)
                {
                    ...
                    {
                        if (
                            clone.PreferredRunner
                            == RunnerVisibilityLink.PreferredRunners.InputAuthority
                        )
                        {
